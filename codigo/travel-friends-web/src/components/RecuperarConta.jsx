    ...
    <div className='grid grid-cols-1 sm:grid-cols-2  h-screen w-full '>
      ...
      <div className='bg-indigo-700   flex flex-col justify-center'>
          <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
              <h2 className='text-4xl dark:text-white font-family:poppins  text-center'>Recuperar Conta</h2>
              ...
              <button className='w-full my-5 py-2 bg-yellow-400 shadow-lg shadow-yellow-400/50 hover:shadow-yellow-500/40 text-white font-semibold rounded-lg '>Salvar</button>
          </form>
      </div>
