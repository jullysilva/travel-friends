    ...
    <div className='grid grid-cols-1 sm:grid-cols-2  h-screen w-full '>
      ...
      <div className='bg-indigo-700   flex flex-col justify-center'>
          <form className='max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg'>
              <h2 className='text-4xl dark:text-white font-family:poppins  text-center'>REGISTRAR</h2>
              ...
              <div className='flex justify-between text-gray-400 py-2 '>
                  <p className='flex items-center'><input  className='mr-2'type="checkbox"/>Ao criar uma conta, você concorda com os Termos e Condições</p>
                  

              </div>

              <div className='flex justify-between text-gray-400 py-2 '>
              <p>Já tem um conta? <button>Entrar</button></p>
              </div >
